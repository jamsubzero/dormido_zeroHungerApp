...
//     */
    ...
    public static WastageFragment newInstance() {
        WastageFragment fragment = new WastageFragment();
...
//    }
    ...
    {
        ProgressDialog pdLoading = new ProgressDialog(WastageFragment.this.getContext());
...
//                String query = builder.build().getEncodedQuery();
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                dataAdapter = new CustomMealsAdapter(WastageFragment.this.getContext(),R.layout.need_info, mealList);
                listView.setAdapter(dataAdapter);
